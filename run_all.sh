...
../test ../small_data/uf_1_4.dat ../small_data/vf_1_4.dat ${DW} ${DH} ${h} ${eps} ../small_data/tracepoints.bin ../small_data/index.bin ../small_data/record.bin ../small_data/position test
